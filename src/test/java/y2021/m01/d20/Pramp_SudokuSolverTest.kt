...
internal class Pramp_SudokuSolverTest {
    ...
    fun tc2() {
        ...
        val input = arrayOf(
            charArrayOf('5', '1', '6', '8', '4', '9', '7', '3', '2'),
            charArrayOf('3', '.', '7', '6', '.', '5', '.', '.', '.'),
            charArrayOf('8', '.', '9', '7', '.', '.', '.', '6', '5'),
            charArrayOf('1', '3', '5', '.', '6', '.', '9', '.', '7'),
            charArrayOf('4', '7', '2', '5', '9', '1', '.', '.', '6'),
            charArrayOf('9', '6', '8', '3', '7', '.', '.', '5', '.'),
            charArrayOf('2', '5', '3', '1', '8', '6', '.', '7', '4'),
            charArrayOf('6', '8', '4', '2', '.', '7', '5', '.', '.'),
            charArrayOf('7', '9', '1', '.', '5', '.', '6', '.', '8')
        )
